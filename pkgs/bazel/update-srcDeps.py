...
if len(sys.argv) == 1:
    ...
    print(
        "Takes the bazel WORKSPACE file and reads all archives into a json dict (by evaling it as python code)",
        file=sys.stderr,
    )
...
def list_source_repository(**kw):
    pass


def new_local_repository(**kw):
    pass


def local_repository(**kw):
    pass
...
def stardoc_repositories(**kw):
    pass


def skydoc_repositories(**kw):
    pass


def rules_sass_dependencies(**kw):
    pass
...
def sass_repositories(**kw):
    pass


def register_execution_platforms(*args):
    pass


def rbe_autoconfig(*args, **kw):
    pass


def rules_pkg_dependencies(*args, **kw):
    pass


def winsdk_configure(*args, **kw):
    pass


def register_local_rc_exe_toolchains(*args, **kw):
    pass


def register_toolchains(*args, **kw):
    pass
